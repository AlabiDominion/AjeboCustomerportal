...
namespace AjeboCustomerPortal.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<UserDetailes> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            // Normalize to a safe local path
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return LocalRedirect(returnUrl); // safe by construction
                }
